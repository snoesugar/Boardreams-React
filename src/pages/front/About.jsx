    ...
    <div className="about-page bg-dark text-primary">
      ...
      <section className="about-hero py-8 text-center position-relative">
        <div className="container position-relative z-1">
          <span className="text-gold-mid fw-bold tracking-widest mb-3 d-block">EST. 2026</span>
          <h2 className="display-2 fw-bold text-gold-gradient mb-4">
            創造回憶的建築師
          </h2>
          <div className="mx-auto bg-gold-gradient mb-5"></div>
          <p className="lead mx-auto mb-5 opacity-75 lh-base">
        ...
        <div className="container">
          ...
          <div className="row align-items-center g-5 mb-9">
            <div className="col-md-6 position-relative">
              <div className="about-img-frame shadow-dream">
                <img
              ...
              <div className="floating-badge d-none d-lg-block">Connect</div>
            </div>
            <div className="col-md-6 ps-lg-6">
              <h3 className="text-gold-gradient mb-4 fw-bold display-5">找回交談的溫度</h3>
          ...
          <div className="row align-items-center flex-row-reverse g-5">
            <div className="col-md-6 position-relative">
              <div className="about-img-frame shadow-dream border-gold-subtle">
                <img
              ...
              <div className="floating-badge-right d-none d-lg-block">Explore</div>
            </div>
            <div className="col-md-6 pe-lg-6">
              <h3 className="text-gold-gradient mb-4 fw-bold display-5">故事的啟動碼</h3>
              <p className="lh-lg fs-5">
      ...
      {/* 3. 數據實績：建立信任感 */}
      <section className="bg-panel py-6 mb-5">
        <div className="container text-center">
          <div className="mb-5">
            <h3 className="text-gold-gradient mb-2">冒險者的旅程紀錄</h3>
      ...
      <section className="container mb-8">
        <div className="text-center mb-6">
          <h3 className="text-gold-gradient">冒險者公約</h3>
      ...
      <section className="bg-panel text-center py-6">
        <div className="p-5 border-gold-subtle rounded-4">
          <h3 className="font-serif text-gold-light mb-4">準備好開啟你的下一場傳說嗎？</h3>
          <p className="text-primary mb-5">加入我們的行列，在方寸之間建築屬於你的夢想。</p>
          <button className="btn btn-outline-gold-light px-5 py-3 rounded-pill tracking-widest">
            瀏覽產品清單
          </button>
        </div>
